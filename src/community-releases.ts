...
export const RELEASES = [
  {
    version: "v0.0.1",
    text: "오늘 *ONE THING*을 채널에 한 문장으로 남겨주세요! 등록 결과와 잔디를 보여주고, 잘못 등록했다면 되돌릴 수 있어요. 써보시고 이 스레드에 의견 남겨주세요 🙌",
  },
  {
    version: "v0.0.19",
    text: "*ONE THING*을 아직 등록하지 않았다면 설정한 시각에 한 번 챙겨드려요. 개인 안내는 알림 설정에서 켜거나 끌 수 있어요. 불편한 점은 이 스레드에 남겨주세요!",
  },
  {
    version: "v0.0.20",
    text: "매일 오전 10시, 봇이 *ONE THING*을 적을 스레드를 열어요. 오늘 중요한 한 가지와 이유를 남겨주세요!!! 🌱",
  },
  {
    version: "v0.0.21",
