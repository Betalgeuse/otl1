...
const ANSWERS = {
  ...
  usage:
    "오늘 최우선순위로 먼저 해결할 중요한 일 한 가지와 이유를 원씽 채널이나 오늘 안내 스레드에 남겨주세요. 멘션은 필수가 아니에요. 완료·일부 진행·후기는 자연어로 알려주면 되고, 애매한 내용은 저장 전에 확인해요. ‘내 상태’로 잔디와 기록을 확인할 수 있어요. 목표 완료와 후기 제출은 별개입니다.",
  weekend:
