...
-- Explicit production mapping prevents private QA data entering public boards.
INSERT INTO otl.workspaces(team_id) VALUES('T0BUVUKB8R5') ON CONFLICT DO NOTHING;
INSERT INTO otl.workspace_channels(team_id,channel_id) VALUES('T0BUVUKB8R5','C0BVB9HSL10') ON CONFLICT DO NOTHING;
UPDATE otl.workspaces SET primary_goal_channel_id='C0BVB9HSL10' WHERE team_id='T0BUVUKB8R5';
DO $$ BEGIN
...
INSERT INTO otl_archive.goal_reconciliation
 ...
 CASE WHEN d.user_id='U0BV52VENTD' AND d.day='2026-09-10' THEN 'https://onething1line.slack.com/archives/C0BVB9HSL10/p1789003194639039' END
...
DO $$ BEGIN
 ...
 AND NOT (team_id='T0BUVUKB8R5' AND user_id='U0BV52VENTD' AND day='2026-09-10'
 AND legacy_before->>'goal_text'='hi'
 AND canonical_before->>'goal'=E'Representation Learning 기반 아키텍쳐 설계\n사유: 기존 HRL 기반 운용 로직 확장성의 한계를 발견함'
 AND (canonical_before->>'outcome'='complete')=(legacy_before->>'completed')::boolean))
 THEN RAISE EXCEPTION 'Unreviewed source disagreement; abort without overwriting'; END IF;
END $$;
