...
ALTER TABLE otl.member_introductions
  DROP CONSTRAINT member_introductions_intro_check;

ALTER TABLE otl.member_introductions
  ADD CONSTRAINT member_introductions_intro_check
  CHECK (intro = '' OR char_length(intro) BETWEEN 1 AND 180);
...
VALUES ('013-multiline-introductions')
