...
const env = { SLACK_TEAM_ID: "TQA", SLACK_BOT_TOKEN: "fake", COMMUNITY_CHANNEL_ID: "CQA", COMMUNITY_PUBLIC_CHANNEL_ID: "CQA", COMMUNITY_BOT_USER_ID: "UBOT", COMMUNITY_ADMIN_ID: "UQA" };
try {
