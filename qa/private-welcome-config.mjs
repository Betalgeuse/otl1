...
assert.equal(WELCOME_GUIDE_RELEASE.version,"v0.0.61");
assert.match(WELCOME_GUIDE_RELEASE.body,/ONE THING 기록하기.*후기 남기기/s);
assert.match(WELCOME_GUIDE_RELEASE.body,/중요한 이유/);
