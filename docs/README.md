...
ONE THING 문서는 **실행 명세**, **제품 원칙**, **시스템 구조**, **사용법**, **운영**, **앞으로의 계획**, **과거 근거**를 구분합니다. 현재 Slack 동작의 단일 기준은 [실행 명세](SPEC.md)입니다. 버전의 출시 여부는 [로드맵](ROADMAP.md)과 [업데이트 이력](UPDATE_HISTORY.md)에서 별도로 관리합니다.

| 알고 싶은 내용 | 읽을 문서 |
| --- | --- |
| 현재 입력·저장·잔디 동작의 기준 | [실행 명세](SPEC.md) |
...
- 실행 동작을 바꾸면 먼저 [실행 명세](SPEC.md)를 고치고, 원칙·구조·사용법·운영 문서에는 중복 본문 대신 링크만 추가합니다.
