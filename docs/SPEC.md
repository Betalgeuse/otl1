...
- **명세 승인·Codex 시작**은 Slack workspace admin 또는 owner만 실행할 수 있습니다. 확정된 명세만 승인 시점의 원격 branch SHA와 함께 GenQuant job으로 만들 수 있습니다. Phase 1은 Codex Cloud에서 재현 증거만 생성하고 원래 피드백 스레드에 상태를 돌려주며, 코드 수정·push·PR·merge는 하지 않습니다.
