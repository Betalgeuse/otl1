...
console.log(JSON.stringify({
  ...
  oauth_config: { scopes: { bot: ["users:read", "users:read.email", "app_mentions:read", "channels:history", "channels:read", "groups:history", "chat:write", "chat:write.public", "im:write", "canvases:read", "canvases:write", "pins:read", "pins:write", "bookmarks:read", "bookmarks:write", "reactions:write", "emoji:read"] } },
