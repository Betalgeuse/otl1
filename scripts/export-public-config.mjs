const PUBLIC_VARS = Object.freeze({
  COMMUNITY_CODEX_USER_ID: "U_REPLACE_CODEX",
  COMMUNITY_OPERATOR_USER_ID: "U_REPLACE_OPERATOR",
  ...
  COMMUNITY_INTRO_CANVAS_ID: "FREPLACEINTROCANVAS",
  COMMUNITY_INTRO_CANVAS_URL: "https://example.slack.com/docs/TREPLACE/FREPLACEINTROCANVAS",
