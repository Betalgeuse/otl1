...
config.vars={COMMUNITY_WELCOME_CHANNEL_ID:'C_REPLACE_WELCOME',COMMUNITY_INTRO_CHANNEL_ID:'C_REPLACE_INTRO',COMMUNITY_GUIDE_SOURCE_TS:'0.000001',COMMUNITY_GUIDE_SOURCE_EDITED_TS:'0.000002',COMMUNITY_GUIDE_FILE_IDS:'FREPLACELOGO,FREPLACEDAILY',COMMUNITY_GUIDE_VERSION:'v0.0.55',COMMUNITY_GUIDE_CONTENT_HASH:'0'.repeat(64),DATABASE_MAINTENANCE:'false',INVITATIONS_ENABLED:'false',DAILY_SCRUM_CHANNEL_ID:'C_REPLACE_DAILY',LLM_PILOT_CHANNEL_ID:'C_REPLACE_ADMIN',LLM_PILOT_USER_ID:'U_REPLACE_ADMIN',COMMUNITY_ENABLED:'true',COMMUNITY_CHANNEL_ID:'C_REPLACE_ADMIN',COMMUNITY_ADMIN_ID:'U_REPLACE_ADMIN',COMMUNITY_BOT_USER_ID:'U_REPLACE_BOT',COMMUNITY_RELEASE_CHANNEL_ID:'C_REPLACE_TOWNHALL',COMMUNITY_FEEDBACK_CHANNEL_ID:'C_REPLACE_FEEDBACK',COMMUNITY_PUBLIC_CHANNEL_ID:'C_REPLACE_DAILY'};
