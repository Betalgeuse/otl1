/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface CloudflareBindings --env-file .dev.vars.example` (hash: c76b7286efcbc9d0a781d2072122101f)
