/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface CloudflareBindings --env-file .dev.vars.example` (hash: 71a0d99cf9941c94006a3e68135a9473)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		COMMUNITY_GUIDE_SOURCE_TS: string;
		COMMUNITY_GUIDE_SOURCE_EDITED_TS: string;
		COMMUNITY_GUIDE_FILE_IDS: string;
		COMMUNITY_GUIDE_VERSION: string;
		COMMUNITY_GUIDE_CONTENT_HASH: string;
