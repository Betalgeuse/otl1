/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface CloudflareBindings` (hash: ff8db62a4d8e83855f9abaaccf08cecf)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		COMMUNITY_BOT_USER_ID: "U0C0ASC06BW";
