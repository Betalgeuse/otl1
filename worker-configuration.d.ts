/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface CloudflareBindings --env-file .dev.vars.example` (hash: b942b1a94d93d3abef8daccfad15f806)
