/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface CloudflareBindings --env-file .dev.vars.example` (hash: 4b4a70166b90f46c995bf4b4da3f9739)
// Runtime types generated with workerd@1.20260131.0 2025-12-01
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CommunityClock";
	}
	interface Env {
		BUG_PRIVATE_OBJECTS: R2Bucket;
		INVITE_PRIVATE_OBJECTS: R2Bucket;
		INTENT_RATE_LIMITER: RateLimit;
		AI: Ai;
		COMMUNITY_CODEX_USER_ID: "U0C2BQ1M79T";
		COMMUNITY_OPERATOR_USER_ID: "U0C406WJA1F";
		COMMUNITY_CHAPTER_CHANNEL_IDS: "C0C07DD9RV0,C0C07S7MLJG,C0C09AGKKPB,C0C112A421L";
		DATABASE_MAINTENANCE: "false";
		DAILY_SCRUM_CHANNEL_ID: "C0BVB9HSL10";
		LLM_PILOT_CHANNEL_ID: "C0C0AMK8068";
		LLM_PILOT_USER_ID: "U0BV52VENTD";
		...
		COMMUNITY_CHANNEL_ID: "C0C0AMK8068";
		COMMUNITY_RELEASE_CHANNEL_ID: "C0C0621V0QZ";
		COMMUNITY_PUBLIC_CHANNEL_ID: "C0BVB9HSL10";
		COMMUNITY_SHAREINFO_CHANNEL_ID: "C0C0RLU4RGQ";
		SLACK_TEAM_ID: string;
		SLACK_SIGNING_SECRET: string;
		SLACK_BOT_TOKEN: string;
		SLACK_OPERATOR_USER_TOKEN: string;
		DATABASE_URL: string;
		GUIDE_DATABASE_URL: string;
		GUIDE_ADMIN_DATABASE_URL: string;
		BOARD_SIGNING_SECRET: string;
		PUBLIC_BASE_URL: string;
		COMMUNITY_OWNER_ID: string;
		BUG_PRIVATE_KEK: string;
		BUG_PRIVATE_KEK_VERSION: string;
		...
		COMMUNITY_GUIDE_CHAPTER_CHANNEL_IDS: string;
		COMMUNITY_GUIDE_CANVAS_ID: string;
		COMMUNITY_GUIDE_CANVAS_URL: string;
		COMMUNITY_GUIDE_ANCHOR_TS: string;
		COMMUNITY_INTRO_CHANNEL_ID: string;
		COMMUNITY_INTRO_CANVAS_ID: string;
		COMMUNITY_INTRO_CANVAS_URL: string;
		COMMUNITY_ADMIN_ID: string;
		SITE_CORE_HMAC_SECRET: string;
		SLACK_SHARED_INVITE_URL: string;
		INVITE_EMAIL_PEPPER: string;
		INVITE_PRIVATE_KEK: string;
		INVITE_PRIVATE_KEK_VERSION: string;
		REFERRAL_TOKEN_SECRET: string;
		LIFECYCLE_ACTION_SECRET: string;
		LIFECYCLE_ADMIN_DATABASE_URL: string;
		REFERRAL_ADMIN_DATABASE_URL: string;
		INTEREST_RUNTIME_DATABASE_URL: string;
		INTEREST_ADMIN_DATABASE_URL: string;
		INTEREST_MEMBER_DATABASE_URL: string;
		INTEREST_ADMIN_CHANNEL_ID: string;
		INTEREST_ACTION_SECRET: string;
		COMMUNITY_CLOCK: DurableObjectNamespace<import("./src/index").CommunityClock>;
	}
}
