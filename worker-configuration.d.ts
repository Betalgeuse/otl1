/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface CloudflareBindings --env-file .dev.vars.example` (hash: 45fbe10b8a3ab1d448ff977dea8f6083)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		COMMUNITY_CODEX_BRANCH: "agent/genquant-runner";
