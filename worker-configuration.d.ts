/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface CloudflareBindings --env-file .dev.vars.example` (hash: 6e9e2ee5e381ca45620f16aba410fb53)
